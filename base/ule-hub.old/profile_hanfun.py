...
class HFServerAttribute:
    ...
    def _pp_to_str(self) -> str:
        ...
        printout += header
        # -----------------------------
        for d in self.attribute_descriptions:
            sign = False
            if len(d) == 3:
                label, start, end = d
            ...
            if sign:
                ...
                if signed_bitstring[0] == '1':
                    ...
                    number += 1
                    number= -number    
            printout_t = "0b{} :{} = {} ({})\n".format(self.f_comma(bitstring[start:end].rjust(end,'.').ljust(bit_length, '.')),
                label, 
                number,
...
class HFInterfaces:
    ...
    def create_known_interfaces(self):
        ...
        attribute_descriptions = [
                                  ...
                                  ('Opertating Mode    ', 0, attribute_type*8),
                                  ]
        ...
        attribute_descriptions = [('Precision Code 0x00 1W/h ', 32, attribute_type*8),
        ...
        attribute_type=1 # U8
        attribute_descriptions = [('State', 0, 1),
                                 ]
        ...
        # OpenClose Interface
        attribute_type=1 # U8
        attribute_descriptions = [('On/Off', 0, 1),
                                  ('in close direction=0', 1, 2),
                                  ('in open direction =1', 1, 2),
                                 ]
        sa1 = HFServerAttribute(attribute_id=1, attribute_name='State', attribute_type=attribute_type, attribute_values=[0],
                                attribute_descriptions=attribute_descriptions)
        ...
        sa3 = HFServerAttribute(attribute_id=3, attribute_name='Motor Direction', attribute_type=attribute_type, attribute_values=[0],
                                attribute_descriptions=attribute_descriptions)
        attribute_descriptions = [('disabled=0', 0, 1),
                                  ('enabled =1', 0, 1),
                                 ]
        ...
        attribute_descriptions = [('Do Nothing=0', 0, 2),
                                  ('Open      =1', 0, 2),
                                  ('Close     =3', 0, 2),
                                 ]
        ...
        payload_descriptions = [('Hue 0-359                         ', 32, attribute_type*8),
                                ('Saturation                        ', 24, 32),
                                ('Direction                         ', 16, 24),
                                ('Direction Up                = 0x01', 16, 18),
                                ('Direction Down              = 0x02', 16, 18),
                                ('Direction Shortest Distance = 0x03', 16, 18),
                                ('Direction Longest Distance  = 0x04', 16, 18),  
                                ('Transition Time 100ms             ', 0, 16),
                              ]
