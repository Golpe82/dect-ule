...
##
# while moving 20%-80%
# blinking light /2/1/70-x
# standard light /2/1/60-x
# background on/off /3/1/10-x
tmpbackgroundurlon = '/hook/snom/47037/?xml=false&variableId=34139&value={"actionID":"{FCE37F48-DA3F-45DD-AC77-71343792CC2D}","parameters":{"VALUE":true,"ENVIRONMENT":"Default","PARENT":47037,"TARGET":34139}}'
tmpbackgroundurloff = '/hook/snom/47037/?xml=false&variableId=34139&value={"actionID":"{FCE37F48-DA3F-45DD-AC77-71343792CC2D}","parameters":{"VALUE":false,"ENVIRONMENT":"Default","PARENT":47037,"TARGET":34139}}'
tmpredwhiteon = '/hook/snom/47037/?xml=false&variableId=27402&value={"actionID":"{FCE37F48-DA3F-45DD-AC77-71343792CC2D}","parameters":{"VALUE":true,"ENVIRONMENT":"Default","PARENT":47037,"TARGET":27402}}'
tmpredwhiteoff = '/hook/snom/47037/?xml=false&variableId=27402&value={"actionID":"{FCE37F48-DA3F-45DD-AC77-71343792CC2D}","parameters":{"VALUE":false,"ENVIRONMENT":"Default","PARENT":47037,"TARGET":27402}}'
tmpdefaultlight = '/hook/snom/47037/?xml=false&variableId=36328&value={"actionID":"{FCE37F48-DA3F-45DD-AC77-71343792CC2D}","parameters":{"VALUE":true,"ENVIRONMENT":"Default","PARENT":47037,"TARGET":36328}}'

actions1 = [HFAction(f'{KNX_GATEWAY_URL}{tmpredwhiteon}',
                        actions_duration = 0.0),
            HFAction(f'{KNX_GATEWAY_URL}{tmpbackgroundurlon}',
                        actions_duration = 0.0),
            ]
actionsclosed = [HFAction(f'{KNX_GATEWAY_URL}{tmpredwhiteoff}',
                        actions_duration = 0.0),
            HFAction(f'{KNX_GATEWAY_URL}{tmpdefaultlight}',
                        actions_duration = 0.0),
            HFAction(f'{KNX_GATEWAY_URL}{tmpbackgroundurloff}',
                        actions_duration = 0.0),
            ]
actionsopened = [HFAction(f'{KNX_GATEWAY_URL}{tmpredwhiteoff}',
                        actions_duration = 0.0),
            HFAction(f'{KNX_GATEWAY_URL}{tmpdefaultlight}',
                        actions_duration = 0.0),
            HFAction(f'{KNX_GATEWAY_URL}{tmpbackgroundurlon}',
